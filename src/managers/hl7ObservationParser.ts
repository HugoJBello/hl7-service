...
export const hl7OBSXDecoderV5 = (bsc: string): HL7DecodedObservationV5I => {
  const result = parseStringSegmentUsingSchema(bsc, HL7ObservationSchemaV5.fields) as HL7DecodedObservationV8I;
...
export const hl7OBSXDecoderV8 = (bsc: string): HL7DecodedObservationV8I => {
  const result = parseStringSegmentUsingSchema(bsc, HL7ObservationSchemaV8.fields) as HL7DecodedObservationV8I;
  result.hl7Segment = Hl7Segment.OBSERVATION;
