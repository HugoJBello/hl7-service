...
// Generated typescript code of HL7v 2.8 FT1  (Financial Transaction)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7FinancialTransactionV8Document = mongoose.Document & HL7FinancialTransactionV8I

const HL7FinancialTransactionV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7FinancialTransactionV8I extends Segment{
  setIdFt1: string
  transactionId: string
  transactionBatchId: string
  transactionDate: string
  ...
  export const HL7FinancialTransactionV8 = mongoose.model<HL7FinancialTransactionV8Document> ("HL7FinancialTransactionV8", HL7FinancialTransactionV8Schema);
