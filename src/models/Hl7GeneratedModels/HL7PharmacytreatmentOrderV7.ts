...
// Generated typescript code of HL7v 2.7 RXO  (Pharmacy/treatment Order)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PharmacytreatmentOrderV7Document = mongoose.Document & HL7PharmacytreatmentOrderV7I

const HL7PharmacytreatmentOrderV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PharmacytreatmentOrderV7I extends Segment{
  requestedGiveCode: string
  requestedGiveAmountMinimum: number
  requestedGiveAmountMaximum: number
  requestedGiveUnits: string
  ...
  export const HL7PharmacytreatmentOrderV7 = mongoose.model<HL7PharmacytreatmentOrderV7Document> ("HL7PharmacytreatmentOrderV7", HL7PharmacytreatmentOrderV7Schema);
