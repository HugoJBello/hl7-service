...
// Generated typescript code of HL7v 2.4 GT1  (Guarantor)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7GuarantorV4Document = mongoose.Document & HL7GuarantorV4I

const HL7GuarantorV4Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7GuarantorV4I extends Segment{
  setIDGT1: string
  ...
  export const HL7GuarantorV4 = mongoose.model<HL7GuarantorV4Document> ("HL7GuarantorV4", HL7GuarantorV4Schema);
