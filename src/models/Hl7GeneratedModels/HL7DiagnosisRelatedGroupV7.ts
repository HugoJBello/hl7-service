...
// Generated typescript code of HL7v 2.7 DRG  (Diagnosis Related Group)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7DiagnosisRelatedGroupV7Document = mongoose.Document & HL7DiagnosisRelatedGroupV7I

const HL7DiagnosisRelatedGroupV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7DiagnosisRelatedGroupV7I extends Segment{
  diagnosticRelatedGroup: string
  drgAssignedDateTime: string
  drgApprovalIndicator: string
  drgGrouperReviewCode: string
  ...
  export const HL7DiagnosisRelatedGroupV7 = mongoose.model<HL7DiagnosisRelatedGroupV7Document> ("HL7DiagnosisRelatedGroupV7", HL7DiagnosisRelatedGroupV7Schema);
