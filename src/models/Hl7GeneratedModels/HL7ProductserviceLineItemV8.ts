...
// Generated typescript code of HL7v 2.8 PSL  (Product/service Line Item)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7ProductserviceLineItemV8Document = mongoose.Document & HL7ProductserviceLineItemV8I

const HL7ProductserviceLineItemV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7ProductserviceLineItemV8I extends Segment{
  providerProductServiceLineItemNumber: string
  payerProductServiceLineItemNumber: string
  productServiceLineItemSequenceNumber: string
  providerTrackingId: string
  ...
  export const HL7ProductserviceLineItemV8 = mongoose.model<HL7ProductserviceLineItemV8Document> ("HL7ProductserviceLineItemV8", HL7ProductserviceLineItemV8Schema);
