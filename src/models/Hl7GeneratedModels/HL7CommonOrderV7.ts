...
// Generated typescript code of HL7v 2.7 ORC  (Common Order)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7CommonOrderV7Document = mongoose.Document & HL7CommonOrderV7I

const HL7CommonOrderV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7CommonOrderV7I extends Segment{
  orderControl: string
  placerOrderNumber: string
  fillerOrderNumber: string
  placerGroupNumber: string
  ...
  export const HL7CommonOrderV7 = mongoose.model<HL7CommonOrderV7Document> ("HL7CommonOrderV7", HL7CommonOrderV7Schema);
