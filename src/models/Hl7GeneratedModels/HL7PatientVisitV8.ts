...
// Generated typescript code of HL7v 2.8 PV1  (Patient Visit)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PatientVisitV8Document = mongoose.Document & HL7PatientVisitV8I

const HL7PatientVisitV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PatientVisitV8I extends Segment{
  setIdPv1: string
  patientClass: string
  assignedPatientLocation: string
  admissionType: string
  ...
  export const HL7PatientVisitV8 = mongoose.model<HL7PatientVisitV8Document> ("HL7PatientVisitV8", HL7PatientVisitV8Schema);
