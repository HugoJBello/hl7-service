...
// Generated typescript code of HL7v 2.8 IN1  (Insurance)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7InsuranceV8Document = mongoose.Document & HL7InsuranceV8I

const HL7InsuranceV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
  ...
  insuranceActionCode: String,
  
  }, { timestamps: true });
  
export interface HL7InsuranceV8I extends Segment{
  setIdIn1: string
  healthPlanId: string
  ...
  export const HL7InsuranceV8 = mongoose.model<HL7InsuranceV8Document> ("HL7InsuranceV8", HL7InsuranceV8Schema);
