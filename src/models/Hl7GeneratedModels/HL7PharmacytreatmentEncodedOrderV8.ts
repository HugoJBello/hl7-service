...
// Generated typescript code of HL7v 2.8 RXE  (Pharmacy/treatment Encoded Order)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PharmacytreatmentEncodedOrderV8Document = mongoose.Document & HL7PharmacytreatmentEncodedOrderV8I

const HL7PharmacytreatmentEncodedOrderV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PharmacytreatmentEncodedOrderV8I extends Segment{
  quantityTiming: string
  giveCode: string
  giveAmountMinimum: number
  giveAmountMaximum: number
  ...
  export const HL7PharmacytreatmentEncodedOrderV8 = mongoose.model<HL7PharmacytreatmentEncodedOrderV8Document> ("HL7PharmacytreatmentEncodedOrderV8", HL7PharmacytreatmentEncodedOrderV8Schema);
