...
// Generated typescript code of HL7v 2.4 PV2  (Patient visit - additional information)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PatientVisitAdditionalInformationV4Document = mongoose.Document & HL7PatientVisitAdditionalInformationV4I

const HL7PatientVisitAdditionalInformationV4Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PatientVisitAdditionalInformationV4I extends Segment{
  priorPendingLocation: string
  accommodationCode: string
  admitReason: string
  transferReason: string
  ...
  export const HL7PatientVisitAdditionalInformationV4 = mongoose.model<HL7PatientVisitAdditionalInformationV4Document> ("HL7PatientVisitAdditionalInformationV4", HL7PatientVisitAdditionalInformationV4Schema);
