...
// Generated typescript code of HL7v 2.8 PV2  (Patient Visit - Additional Information)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PatientVisitAdditionalInformationV8Document = mongoose.Document & HL7PatientVisitAdditionalInformationV8I

const HL7PatientVisitAdditionalInformationV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PatientVisitAdditionalInformationV8I extends Segment{
  priorPendingLocation: string
  accommodationCode: string
  admitReason: string
  transferReason: string
  ...
  export const HL7PatientVisitAdditionalInformationV8 = mongoose.model<HL7PatientVisitAdditionalInformationV8Document> ("HL7PatientVisitAdditionalInformationV8", HL7PatientVisitAdditionalInformationV8Schema);
