...
// Generated typescript code of HL7v 2.5 IN3  (Insurance Additional Information, Certification)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7InsuranceAdditionalInformationCertificationV5Document = mongoose.Document & HL7InsuranceAdditionalInformationCertificationV5I

const HL7InsuranceAdditionalInformationCertificationV5Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7InsuranceAdditionalInformationCertificationV5I extends Segment{
  setIDIN3: string
  certificationNumber: string
  certifiedBy: string[]
  certificationRequired: string
  ...
  export const HL7InsuranceAdditionalInformationCertificationV5 = mongoose.model<HL7InsuranceAdditionalInformationCertificationV5Document> ("HL7InsuranceAdditionalInformationCertificationV5", HL7InsuranceAdditionalInformationCertificationV5Schema);
