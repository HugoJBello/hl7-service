...
// Generated typescript code of HL7v 2.7 OBR  (Observation Request)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7ObservationRequestV7Document = mongoose.Document & HL7ObservationRequestV7I

const HL7ObservationRequestV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7ObservationRequestV7I extends Segment{
  setIdObr: string
  placerOrderNumber: string
  fillerOrderNumber: string
  universalServiceIdentifier: string
  ...
  export const HL7ObservationRequestV7 = mongoose.model<HL7ObservationRequestV7Document> ("HL7ObservationRequestV7", HL7ObservationRequestV7Schema);
