...
// Generated typescript code of HL7v 2.5 PRB  (Problem Details)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7ProblemDetailsV5Document = mongoose.Document & HL7ProblemDetailsV5I

const HL7ProblemDetailsV5Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7ProblemDetailsV5I extends Segment{
  actionCode: string
  actionDateTime: Date
  problemID: string
  problemInstanceID: string
  ...
  export const HL7ProblemDetailsV5 = mongoose.model<HL7ProblemDetailsV5Document> ("HL7ProblemDetailsV5", HL7ProblemDetailsV5Schema);
