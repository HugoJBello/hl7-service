...
// Generated typescript code of HL7v 2.7 UB2  (Uniform Billing Data)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7UniformBillingDataV7Document = mongoose.Document & HL7UniformBillingDataV7I

const HL7UniformBillingDataV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7UniformBillingDataV7I extends Segment{
  setIdUb2: string
  coinsuranceDays9: string
  ...
  export const HL7UniformBillingDataV7 = mongoose.model<HL7UniformBillingDataV7Document> ("HL7UniformBillingDataV7", HL7UniformBillingDataV7Schema);
