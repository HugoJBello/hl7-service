...
// Generated typescript code of HL7v 2.8 SPM  (Specimen)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7SpecimenV8Document = mongoose.Document & HL7SpecimenV8I

const HL7SpecimenV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7SpecimenV8I extends Segment{
  setIdSpm: string
  specimenId: string
  ...
  export const HL7SpecimenV8 = mongoose.model<HL7SpecimenV8Document> ("HL7SpecimenV8", HL7SpecimenV8Schema);
