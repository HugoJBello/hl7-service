...
// Generated typescript code of HL7v 2.5 PCR  (Possible Causal Relationship)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PossibleCausalRelationshipV5Document = mongoose.Document & HL7PossibleCausalRelationshipV5I

const HL7PossibleCausalRelationshipV5Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PossibleCausalRelationshipV5I extends Segment{
  implicatedProduct: string
  genericProduct: string
  productClass: string
  totalDurationOfTherapy: string
  ...
  export const HL7PossibleCausalRelationshipV5 = mongoose.model<HL7PossibleCausalRelationshipV5Document> ("HL7PossibleCausalRelationshipV5", HL7PossibleCausalRelationshipV5Schema);
