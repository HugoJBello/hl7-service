...
// Generated typescript code of HL7v 2.4 IN2  (Insurance Additional Information)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7InsuranceAdditionalInformationV4Document = mongoose.Document & HL7InsuranceAdditionalInformationV4I

const HL7InsuranceAdditionalInformationV4Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
  ...
  race: Array(String),
  hCFAPatientsRelationshipToInsured: String,
  
  }, { timestamps: true });
  
export interface HL7InsuranceAdditionalInformationV4I extends Segment{
  ...
  export const HL7InsuranceAdditionalInformationV4 = mongoose.model<HL7InsuranceAdditionalInformationV4Document> ("HL7InsuranceAdditionalInformationV4", HL7InsuranceAdditionalInformationV4Schema);
