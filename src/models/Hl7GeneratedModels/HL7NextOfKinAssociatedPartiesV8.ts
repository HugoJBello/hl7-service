...
// Generated typescript code of HL7v 2.8 NK1  (Next Of Kin / Associated Parties)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7NextOfKinAssociatedPartiesV8Document = mongoose.Document & HL7NextOfKinAssociatedPartiesV8I

const HL7NextOfKinAssociatedPartiesV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7NextOfKinAssociatedPartiesV8I extends Segment{
  setIdNk1: string
  name: string[]
  relationship: string
  address: string[]
  ...
  export const HL7NextOfKinAssociatedPartiesV8 = mongoose.model<HL7NextOfKinAssociatedPartiesV8Document> ("HL7NextOfKinAssociatedPartiesV8", HL7NextOfKinAssociatedPartiesV8Schema);
