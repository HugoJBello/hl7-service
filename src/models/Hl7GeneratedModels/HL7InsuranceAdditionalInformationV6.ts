...
// Generated typescript code of HL7v 2.6 IN2  (Insurance Additional Information)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7InsuranceAdditionalInformationV6Document = mongoose.Document & HL7InsuranceAdditionalInformationV6I

const HL7InsuranceAdditionalInformationV6Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7InsuranceAdditionalInformationV6I extends Segment{
  ...
  export const HL7InsuranceAdditionalInformationV6 = mongoose.model<HL7InsuranceAdditionalInformationV6Document> ("HL7InsuranceAdditionalInformationV6", HL7InsuranceAdditionalInformationV6Schema);
