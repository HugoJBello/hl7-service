...
// Generated typescript code of HL7v 2.7 PID  (Patient Identification)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PatientIdentificationV7Document = mongoose.Document & HL7PatientIdentificationV7I

const HL7PatientIdentificationV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PatientIdentificationV7I extends Segment{
  setIdPid: string
  patientId: string
  ...
  export const HL7PatientIdentificationV7 = mongoose.model<HL7PatientIdentificationV7Document> ("HL7PatientIdentificationV7", HL7PatientIdentificationV7Schema);
