...
// Generated typescript code of HL7v 2.7 OM2  (Numeric Observation)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7NumericObservationV7Document = mongoose.Document & HL7NumericObservationV7I

const HL7NumericObservationV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7NumericObservationV7I extends Segment{
  sequenceNumberTestObservationMasterFile: number
  unitsOfMeasure: string
  ...
  export const HL7NumericObservationV7 = mongoose.model<HL7NumericObservationV7Document> ("HL7NumericObservationV7", HL7NumericObservationV7Schema);
