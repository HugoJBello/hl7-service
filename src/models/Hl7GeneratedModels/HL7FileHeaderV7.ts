...
// Generated typescript code of HL7v 2.7 FHS  (File Header)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7FileHeaderV7Document = mongoose.Document & HL7FileHeaderV7I

const HL7FileHeaderV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7FileHeaderV7I extends Segment{
  fileFieldSeparator: string
  fileEncodingCharacters: string
  fileSendingApplication: string
  fileSendingFacility: string
  ...
  export const HL7FileHeaderV7 = mongoose.model<HL7FileHeaderV7Document> ("HL7FileHeaderV7", HL7FileHeaderV7Schema);
