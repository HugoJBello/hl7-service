...
// Generated typescript code of HL7v 2.6 PD1  (Patient Additional Demographic)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PatientAdditionalDemographicV6Document = mongoose.Document & HL7PatientAdditionalDemographicV6I

const HL7PatientAdditionalDemographicV6Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PatientAdditionalDemographicV6I extends Segment{
  ...
  export const HL7PatientAdditionalDemographicV6 = mongoose.model<HL7PatientAdditionalDemographicV6Document> ("HL7PatientAdditionalDemographicV6", HL7PatientAdditionalDemographicV6Schema);
