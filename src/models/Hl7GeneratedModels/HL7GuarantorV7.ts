...
// Generated typescript code of HL7v 2.7 GT1  (Guarantor)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7GuarantorV7Document = mongoose.Document & HL7GuarantorV7I

const HL7GuarantorV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7GuarantorV7I extends Segment{
  setIdGt1: string
  ...
  export const HL7GuarantorV7 = mongoose.model<HL7GuarantorV7Document> ("HL7GuarantorV7", HL7GuarantorV7Schema);
