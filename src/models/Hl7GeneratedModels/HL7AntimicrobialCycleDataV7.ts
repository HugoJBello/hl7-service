...
// Generated typescript code of HL7v 2.7 SCD  (Anti-microbial Cycle Data)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7AntimicrobialCycleDataV7Document = mongoose.Document & HL7AntimicrobialCycleDataV7I

const HL7AntimicrobialCycleDataV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7AntimicrobialCycleDataV7I extends Segment{
  cycleStartTime: string
  cycleCount: number
  tempMax: string
  tempMin: string
  ...
  export const HL7AntimicrobialCycleDataV7 = mongoose.model<HL7AntimicrobialCycleDataV7Document> ("HL7AntimicrobialCycleDataV7", HL7AntimicrobialCycleDataV7Schema);
