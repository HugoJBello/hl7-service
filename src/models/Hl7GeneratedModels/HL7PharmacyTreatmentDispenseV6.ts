...
// Generated typescript code of HL7v 2.6 RXD  (Pharmacy/Treatment Dispense)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PharmacyTreatmentDispenseV6Document = mongoose.Document & HL7PharmacyTreatmentDispenseV6I

const HL7PharmacyTreatmentDispenseV6Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PharmacyTreatmentDispenseV6I extends Segment{
  dispenseSubIDCounter: number
  dispenseGiveCode: string
  dateTimeDispensed: string
  actualDispenseAmount: number
  ...
  export const HL7PharmacyTreatmentDispenseV6 = mongoose.model<HL7PharmacyTreatmentDispenseV6Document> ("HL7PharmacyTreatmentDispenseV6", HL7PharmacyTreatmentDispenseV6Schema);
