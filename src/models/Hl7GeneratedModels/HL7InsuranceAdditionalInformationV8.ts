...
// Generated typescript code of HL7v 2.8 IN2  (Insurance Additional Information)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7InsuranceAdditionalInformationV8Document = mongoose.Document & HL7InsuranceAdditionalInformationV8I

const HL7InsuranceAdditionalInformationV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7InsuranceAdditionalInformationV8I extends Segment{
  ...
  export const HL7InsuranceAdditionalInformationV8 = mongoose.model<HL7InsuranceAdditionalInformationV8Document> ("HL7InsuranceAdditionalInformationV8", HL7InsuranceAdditionalInformationV8Schema);
