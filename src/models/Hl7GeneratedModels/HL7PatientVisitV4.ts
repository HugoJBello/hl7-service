...
// Generated typescript code of HL7v 2.4 PV1  (Patient visit)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PatientVisitV4Document = mongoose.Document & HL7PatientVisitV4I

const HL7PatientVisitV4Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PatientVisitV4I extends Segment{
  setIDPV1: string
  patientClass: string
  assignedPatientLocation: string
  admissionType: string
  ...
  export const HL7PatientVisitV4 = mongoose.model<HL7PatientVisitV4Document> ("HL7PatientVisitV4", HL7PatientVisitV4Schema);
