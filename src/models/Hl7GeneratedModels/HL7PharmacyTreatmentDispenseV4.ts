...
// Generated typescript code of HL7v 2.4 RXD  (Pharmacy/Treatment Dispense)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PharmacyTreatmentDispenseV4Document = mongoose.Document & HL7PharmacyTreatmentDispenseV4I

const HL7PharmacyTreatmentDispenseV4Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PharmacyTreatmentDispenseV4I extends Segment{
  dispenseSubIDCounter: number
  dispenseGiveCode: string
  dateTimeDispensed: Date
  actualDispenseAmount: number
  ...
  export const HL7PharmacyTreatmentDispenseV4 = mongoose.model<HL7PharmacyTreatmentDispenseV4Document> ("HL7PharmacyTreatmentDispenseV4", HL7PharmacyTreatmentDispenseV4Schema);
