...
// Generated typescript code of HL7v 2.5 FAC  (Facility)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7FacilityV5Document = mongoose.Document & HL7FacilityV5I

const HL7FacilityV5Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7FacilityV5I extends Segment{
  facilityIDFAC: string
  facilityType: string
  ...
  export const HL7FacilityV5 = mongoose.model<HL7FacilityV5Document> ("HL7FacilityV5", HL7FacilityV5Schema);
