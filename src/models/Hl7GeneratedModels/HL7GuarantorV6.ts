...
// Generated typescript code of HL7v 2.6 GT1  (Guarantor)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7GuarantorV6Document = mongoose.Document & HL7GuarantorV6I

const HL7GuarantorV6Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7GuarantorV6I extends Segment{
  setIDGT1: string
  ...
  export const HL7GuarantorV6 = mongoose.model<HL7GuarantorV6Document> ("HL7GuarantorV6", HL7GuarantorV6Schema);
