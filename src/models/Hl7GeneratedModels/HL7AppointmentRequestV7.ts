...
// Generated typescript code of HL7v 2.7 ARQ  (Appointment Request)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7AppointmentRequestV7Document = mongoose.Document & HL7AppointmentRequestV7I

const HL7AppointmentRequestV7Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7AppointmentRequestV7I extends Segment{
  placerAppointmentId: string
  fillerAppointmentId: string
  occurrenceNumber: number
  placerGroupNumber: string
  ...
  export const HL7AppointmentRequestV7 = mongoose.model<HL7AppointmentRequestV7Document> ("HL7AppointmentRequestV7", HL7AppointmentRequestV7Schema);
