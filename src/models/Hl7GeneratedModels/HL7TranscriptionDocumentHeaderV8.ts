...
// Generated typescript code of HL7v 2.8 TXA  (Transcription Document Header)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7TranscriptionDocumentHeaderV8Document = mongoose.Document & HL7TranscriptionDocumentHeaderV8I

const HL7TranscriptionDocumentHeaderV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7TranscriptionDocumentHeaderV8I extends Segment{
  setIdTxa: string
  documentType: string
  documentContentPresentation: string
  activityDateTime: string
  ...
  export const HL7TranscriptionDocumentHeaderV8 = mongoose.model<HL7TranscriptionDocumentHeaderV8Document> ("HL7TranscriptionDocumentHeaderV8", HL7TranscriptionDocumentHeaderV8Schema);
