...
// Generated typescript code of HL7v 2.6 PV2  (Patient Visit - Additional Information)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7PatientVisitAdditionalInformationV6Document = mongoose.Document & HL7PatientVisitAdditionalInformationV6I

const HL7PatientVisitAdditionalInformationV6Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7PatientVisitAdditionalInformationV6I extends Segment{
  priorPendingLocation: string
  accommodationCode: string
  admitReason: string
  transferReason: string
  ...
  export const HL7PatientVisitAdditionalInformationV6 = mongoose.model<HL7PatientVisitAdditionalInformationV6Document> ("HL7PatientVisitAdditionalInformationV6", HL7PatientVisitAdditionalInformationV6Schema);
