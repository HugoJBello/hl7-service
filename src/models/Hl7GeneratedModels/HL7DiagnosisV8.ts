...
// Generated typescript code of HL7v 2.8 DG1  (Diagnosis)

import mongoose from "mongoose";
import Segment from "./Segment";

export type HL7DiagnosisV8Document = mongoose.Document & HL7DiagnosisV8I

const HL7DiagnosisV8Schema = new mongoose.Schema({
  hl7Segment: String,
  hl7version: String,
  id: String,
...
export interface HL7DiagnosisV8I extends Segment{
  setIdDg1: string
  diagnosisCodingMethod: string
  diagnosisCodeDg1: string
  diagnosisDescription: string
  ...
  export const HL7DiagnosisV8 = mongoose.model<HL7DiagnosisV8Document> ("HL7DiagnosisV8", HL7DiagnosisV8Schema);
