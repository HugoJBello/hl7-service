...
describe("Hl7 generic parser", () => {
  it("should return 200 OK", (done) => {
    ...
    const parsedObs = hl7Decoder(observationHl7StringExample, Hl7Version.v5, Hl7Segment.Observationresult);
    console.log(parsedObs);
    expect(parsedObs).toBeDefined();
    expect((parsedObs as any).dateTimeOfTheObservation).toBeDefined();
    done();
  });
});
