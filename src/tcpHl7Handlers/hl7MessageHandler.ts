...
import { hl7RXADecoder } from "../managers/hl7TreatmentAdministrationParser";
...
export const messageHandler = (hl7MessageString: string) => {
  ...
  for (const payloadPart of lines) {
    ...
    switch (payloadPart.hl7Key) {
      ...
      case Hl7Segment.TREATMENT_ADMINISTRATION:
        const treatmentAdministration = hl7RXADecoder(payloadPart.hl7BodyPart, hl7Version);
        decodedMessage.push(treatmentAdministration);
    }
  }
